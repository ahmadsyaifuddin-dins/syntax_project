    ...
    private function getMateriPerpustakaan()
    {
        return [
            ...
            3 => [
                ...
                'teks' => '<p class="mb-3 text-gray-800">Data biasanya dikirim dari form HTML menggunakan method <code>POST</code>. Di file PHP, kita menangkapnya dengan variabel global <code>$_POST</code>.</p><div class="bg-black text-orange-400 p-3 text-xs rounded border-2 border-gray-700 mb-3 shadow-inner font-mono overflow-x-auto whitespace-pre"><span class="text-gray-500">&lt;!-- 1. Form HTML --&gt;</span>\n&lt;form action="simpan.php" method="POST"&gt;\n   &lt;input type="text" name="judul"&gt;\n&lt;/form&gt;\n\n<span class="text-gray-500">// 2. Tangkap di PHP</span>\n$judul = $_POST[\'judul\'];</div>',
            ...
            5 => [
                ...
                'teks' => '<p class="mb-3 text-gray-800">Menghapus data juga sangat bergantung pada klausa <code>WHERE</code>. Biasanya, ID dikirim melalui URL dan ditangkap dengan metode <code>GET</code>.</p><div class="bg-black text-pink-400 p-3 text-xs rounded border-2 border-gray-700 mb-3 shadow-inner font-mono whitespace-pre"><span class="text-gray-500">&lt;!-- 1. Tombol Hapus HTML --&gt;</span>\n&lt;a href="hapus.php?id=5"&gt;Hapus Data&lt;/a&gt;\n\n<span class="text-gray-500">// 2. Tangkap URL & Delete (PHP)</span>\n$id = $_GET[\'id\'];\nDELETE FROM tabel WHERE id = \'$id\';</div>',
